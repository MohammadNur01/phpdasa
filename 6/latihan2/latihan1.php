...
<body>
    <h1>Gunung yg menarik untuk di daki</h1>

    <?php foreach ($gunung as $gn) : ?>
    <ul>
        <li>
        <img src="img2/<?= $gn ["gambar"] ?>">
        </li>
        <li>Nama : <?= $gn ["nama"]; ?></li>
        <li>Elevasi : <?= $gn ["elevasi"]; ?></li>
        <li>Lokasi : <?= $gn ["lokasi"]; ?></li>
        <li>Akomodasi : <?= $gn ["akomodasi"]; ?></li>
        <li>Basecamp : <?= $gn ["basecamp"]; ?></li>
    </ul>
    <?php endforeach; ?>
</body>
</html>
